...
| Read a Target attribute in Experience offer code to dynamically populate experience | read a Customer attribute |  | var a = "${crs.YOUR_CUSTOMER_ATTRIBUTE_INTEGRATION_NAME.ATTRIBUTE_NAME}"<br>// YOUR_CUSTOMER_ATTRIBUTE_INTEGRATION_NAME is name of the Customer Attribute integration - its not alias |
