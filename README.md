...
| Passing Profile Attributes  to the HTML offer |  | profile attribute  | [Adobe Target Passing Dynamic Attributes](https://experienceleague.adobe.com/docs/target/using/experiences/offers/passing-profile-attributes-to-the-html-offer.html) |
